...
public class RedisKeyUtil {
    ...
    // 抽奖次数
    private static final String PREFIX_LOTTERYTIMES = "lotteryTimes";
    // 抽奖次数
    private static final String PREFIX_SCORE = "score";

    // 生成当前积分的key
    public static String getScore(int userId,String username){
        return PREFIX_SCORE+SPLIT+userId+SPLIT+username;
    }

    // 生成抽奖次数的key
    public static String getLotteryTimesKey(int userId,String username){
        return PREFIX_LOTTERYTIMES+SPLIT+userId+SPLIT+username;
    }

    // 生成某个库存的key
    public static String getInventoryKey(int id){
        return PREFIX_INVENTORY + SPLIT + id;
    }
